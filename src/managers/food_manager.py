...
class FoodManager:
    ...
    def __init__(
        ...
        food_location: Location = self._get_new_food_location()
        self.food: Food = Food(food_location[0], food_location[1])
    ...
    def _draw_food(self, food_x_px: int, food_y_px: int) -> None:
        ...
        self.food.update_location(center)

    def draw_food(self):
        food_x_px, food_y_px = self.food.get_location()
